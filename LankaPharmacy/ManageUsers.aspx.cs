...
namespace LankaPharmacy
{
    public partial class ManageUsers : System.Web.UI.Page
    {
        ...
        protected void btn_Search_Click(object sender, EventArgs e)
        {
            try
            {
                //searching for a paticular user according to the input text
        ...
        protected void btn_add_Click(object sender, EventArgs e)
        {
            ...
            {//adding a new user to the db
                sdm.modifyData("insert into Users (Username,Password,First_Name,Last_Name,Age,Email,Address,User_Type) values ('" + Username.Text + "','" + password.Text + "','" + Fname.Text + "','" + Lname.Text + "','" + int.Parse(Age.Text) + "','" + Email.Text + "','" + Address.Text + "','"+ddl_Utype.Text+"')");
