<%@ Page Title="" Language="C#" MasterPageFile="~/LoginRegistrationMaster.Master" AutoEventWireup="true" CodeBehind="ManageEmployees.aspx.cs" Inherits="LankaPharmacy.ManageEmployees" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <ul class="nav">
            ...
            <li><a href="ManageEmployees.aspx" class="active" >Manage Employees</a></li>
            <li><a href="ManageWages.aspx" >Manage Wages</a></li>
              <li><a href="Reports.aspx" >Reports</a></li>
            </ul>
    </div <div style="font-family: 'Copperplate Gothic Bold';">
         <table align="center"  class="auto-style1" >
        <tr>
            <td colspan="2" align="center"><h2>Manage Employees</h2></td>
        ...
        <tr>
            <td class="auto-style13"><strong>Employee ID</strong></td>
            <td class="auto-style13">
                <asp:TextBox ID="employee_ID" runat="server" Height="30px" Width="327px" CssClass="auto-style3"></asp:TextBox>
                <br />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="employee_ID" ErrorMessage="Please Enter Employee ID!" ForeColor="Red"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="auto-style7"><strong>CNO</strong></td>
            <td class="auto-style7">
                <asp:TextBox ID="CNo" runat="server" Height="30px" Width="327px"></asp:TextBox>
                <asp:RequiredFieldValidator ID="Validate_username" runat="server" ControlToValidate="CNo" ErrorMessage="CNO  is empty!" ForeColor="Red">*</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td class="auto-style8"><strong>Salary</strong></td>
            <td class="auto-style8">
                <asp:TextBox ID="Salary" runat="server" Height="30px" Width="327px"></asp:TextBox>
                <asp:RequiredFieldValidator ID="Validate_password" runat="server" ControlToValidate="Salary" ErrorMessage="Salary  is empty!" ForeColor="Red">*</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="auto-style15"><strong>Employee Type</strong></td>
            <td class="auto-style15">
                <asp:DropDownList ID="ddl_Etype" runat="server" CssClass="auto-style35" Width="321px">
    ...
    <div algin="center">
        ...
        <asp:GridView ID="gv_Employees" runat="server" CellPadding="4" align="center" ForeColor="CornflowerBlue" GridLines="None" Width="725px" AutoGenerateSelectButton="True" BackColor="CornflowerBlue" BorderColor="CornflowerBlue" OnSelectedIndexChanged="gv_Employees_SelectedIndexChanged">
