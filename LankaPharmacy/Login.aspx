<%@ Page Title="" Language="C#" MasterPageFile="~/LoginRegistrationMaster.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="LankaPharmacy.Login" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table align="center" class="auto-style1" style="background-color: #DDE4E6" >
        ...
        <tr>
            <td align="center" class="auto-style4" ><strong>Username</strong></td>
            <td>
        ...
        <tr>
            <td align="center" class="auto-style4" ><b>Password</b></td>
            <td>
